...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/km3pipe-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14007&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/km3pipe-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `km3pipe` can be installed with:

```
conda install km3pipe
```

It is possible to list all of the versions of `km3pipe` available on your platform with:
